...
local Descriptionmaintext=gui.Text(DescriptionGroupbox,"都是没有用的废话，反正这个lua会自动更新，有时间我就会更新新的音乐盒")
local Descriptionmaintext=gui.Text(DescriptionGroupbox,"添加了新的音乐盒你急了！")
local Descriptionmaintext=gui.Text(DescriptionGroupbox,"添加了新的音乐盒闪光舞")
